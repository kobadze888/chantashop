    ...
    <>
      ...
      <div className="container mx-auto px-4 flex gap-12 relative mt-2 md:mt-0" ref={productsTopRef}>
        ...
        <div className="flex-1">
            ...
            <div className={`grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-3 gap-y-6 md:gap-x-4 md:gap-y-8 transition-opacity duration-300 ${isPending ? 'opacity-50 pointer-events-none' : 'opacity-100'}`}>
