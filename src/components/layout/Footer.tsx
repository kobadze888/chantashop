...
export default function Footer() {
  ...
  return (
    <footer className="bg-brand-dark text-white pt-24 pb-[calc(5rem+env(safe-area-inset-bottom))] md:pb-12 md:rounded-t-[3rem] mt-auto relative z-10 overflow-hidden">
