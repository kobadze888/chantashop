...
import { useParams } from 'next/navigation'; // ✅ დაემატა useParams
...
export default function Header() {
  ...
  const params = useParams(); // ✅ ვიღებთ მიმდინარე პარამეტრებს
  ...
  const handleLanguageChange = (nextLocale: string) => {
    startTransition(() => {
      // ✅ FIX: გადავცემთ pathname-ს და params-ს ერთ ობიექტში
      // @ts-expect-error -- TypeScript ვერ ხვდება, რომ params ემთხვევა pathname-ს, მაგრამ რანთაიმში ეს სწორია
